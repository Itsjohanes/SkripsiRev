...
--
-- Host: localhost:3306
-- Generation Time: Jun 30, 2023 at 12:45 PM
...
(2, 'johanesalex774@gmail.com', 'Johannes Alexander Putra', '$2y$10$lxlUu/bTxPyE/ZYr5k6tB.g0q9MHa8CAvTToDCJc0nCZ6HpYigWM2', 1),
...
(12, 'a455dlgrowtopia@gmail.com', 'Kevin', '$2y$10$c4zrWxv6sJCiJGkbPjMruu318b.2sqwVLxGHNVNnLHQPu9B6ezqk2', 0),
(13, 'a455wwlgrowtopia@gmail.com', 'Jie', '$2y$10$.sl9.MQ49Ob.LB1rOexO3eQPQwZli2PSGD8lwIUF5QfFeg5Fc/ZqS', 0),
(14, 'johannesap@upi.edu', 'Kevina', '$2y$10$zROPeT9UQPHQpst1ArZimONOT7TLSPVyTHiAiC3KRhckBQKvpvKTG', 0),
(16, 'dian@upi.edu', 'Dian Lestari,M.Pd.', '$2y$10$mRVEfFIqL//Kj03/cLqCwuCzuRRP1JVP2orr5bMPzFFDe41261t96', 0);
...
INSERT INTO `tb_groupchat` (`id`, `sender_id`, `message`, `kelompok`, `created_at`) VALUES
(1, 14, 'pp', 4, '2023-06-19 13:48:49'),
(2, 11, 'Chat', 3, '2023-06-19 13:57:06'),
(3, 2, 'tes', 4, '2023-06-19 15:06:03'),
(4, 2, 'masuk pa eko', 4, '2023-06-19 15:14:22'),
(5, 2, 'jkljk\n', 1, '2023-06-22 03:44:21'),
(6, 2, 'hentai', 4, '2023-06-22 03:45:21'),
(7, 3, 'gtes', 2, '2023-06-24 00:07:21'),
(8, 2, 'Ini grup 1', 1, '2023-06-30 06:49:50');
...
(47, '100', 1, 3, 'Sudah bagus', '', '768452b093fe80ccc58feb5b1220d80f.pdf'),
(49, '', 3, 2, '', '', '151ee74d12136a89760dc96fe9d3431f.pdf'),
(53, '100', 1, 14, 'keren bro', '', '3f1da01d781938ad969da5379f6742b9.pdf'),
(63, '', 4, 16, '', 'tes', 'aaf72886eee2ed76370e99922aef83a8.pdf'),
(65, '', 1, 16, '', 'Ini tugas Pertemuan 1 ya bang', '0117976242289395c09886aaf5c32e63.pdf'),
(67, '', 3, 16, '', 'Pertemuan 3', '7cad9a792639ad06a8dd6048c0dc213b.pdf'),
(68, '', 2, 16, '', '', 'b0d5549652faf0aa13160e8f9b4fb5ca.pdf');
...
--
ALTER TABLE `tb_hasilposttest`
  MODIFY `id_hasilposttest` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `tb_hasilpretest`
--
ALTER TABLE `tb_hasilpretest`
  MODIFY `id_hasilpretest` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `tb_hasiltugas`
--
ALTER TABLE `tb_hasiltugas`
  MODIFY `id_hasiltugas` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
...
--
ALTER TABLE `tb_pesan`
  MODIFY `id_pesan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT for table `tb_posttest`
--
ALTER TABLE `tb_posttest`
  MODIFY `id_posttest` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `tb_pretest`
--
ALTER TABLE `tb_pretest`
  MODIFY `id_pretest` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table `tb_random`
--
ALTER TABLE `tb_random`
  MODIFY `id_random` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=156;
