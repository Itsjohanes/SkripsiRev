...
--
-- Host: localhost:3306
-- Generation Time: Dec 31, 2023 at 02:33 AM
...
(2, 'johanesalex774@gmail.com', 'Johannes Alexander Putra', '$2y$10$iWREPkkavBeyov1YIwiQluRgpMQPgQChxnWdvrEhVLpWUBQGJVgRm', 1),
(3, 'johannes@upi.edu', 'Putra', '$2y$10$jUdluVMq/zoW1eob56Md9OmVHGnxvdPWwz3n2djYZX3ZRl9HOp.YW', 0),
(11, 'a455lgrowtopia@gmail.com', 'Doni', '$2y$10$8NQTbhYMvC7HKpYXZfnAhenLvS.8wJ3A1ILaneB7T3bhPn7rF13Ta', 0),
(12, 'a455dlgrowtopia@gmail.com', 'Kevin', '$2y$10$eLOxsiRTVEnDg9Mo8HAy8.hh5EC9Ym49dh5kFP80zAIHdT0GiY2Ne', 0),
(13, 'a455wwlgrowtopia@gmail.com', 'Jie', '$2y$10$xkXsD38vaLDs6rx4cWwBPeBvXPgOtelESrkout8/CoOsPT01v1h1C', 0),
(14, 'johannesap@upi.edu', 'Kevina', '$2y$10$GhMjyyLyJiTzqS5doq/KnuVpAkkaVibkI3AP6S9NB09vCavJOtg/q', 0),
...
(1, 16, 1, '2023-11-04 03:55:23'),
(2, 16, 2, '2023-11-04 03:55:50'),
(3, 3, 1, '2023-11-25 05:56:15');
...
(65, 3, 2, 'betul', 23, '2023-10-24 03:37:45', '2023-10-24 03:37:45');
...
(30, 11, 'OK', '2023-11-28 02:15:56'),
(31, 3, 'tes', '2023-11-29 09:09:54'),
(32, 3, 'tes', '2023-11-29 09:09:58'),
(33, 2, 'tes', '2023-12-01 14:06:02'),
(34, 2, 'johannes', '2023-12-05 04:54:18'),
(35, 16, 'tes', '2023-12-21 03:27:44');
...
--
-- Dumping data for table `tb_hasilapersepsi`
--

INSERT INTO `tb_hasilapersepsi` (`id_hasilapersepsi`, `id_siswa`, `id_pertemuan`, `jawaban`, `orientasi`) VALUES
(2, 3, 1, 'Cukup', 1),
(3, 3, 2, 'Pernah, kalo 2 kasus kita hanya ada 2 kasus membandingkan 2 kasus saja, kalo 3 kasus kita pakai 3 kasus, kalo switch memang bisa digunakan untuk menggantikan 2 kasus maupun 3 kasus namun switch pakai case jadi perbandingannya hanya bisa == \r\n', 1),
(4, 16, 1, 'Saya Pernah mendengar', 1),
(5, 3, 4, 'GG', 1),
(6, 3, 3, 'ya', 1),
(7, 3, 1, 'Pernah Pa', 1),
(9, 11, 1, 'Saya Pernah ', 1),
(10, 16, 2, 'Hebat', 1),
(11, 16, 3, 'keren', 1),
(12, 16, 4, 'Ya', 1),
(13, 11, 2, 'ya', 1),
...
(16, 13, 1, 'OK', 1),
(17, 13, 1, 'OK', 1),
(18, 12, 4, 'Pernah, jadi bedanya itu..', 1);
...
(75, 16, 'ABAB', 100, 100, 100, 100, 100, 4, 0, 0, 1, '2023-11-04 04:29:46'),
(76, 16, 'AAAA', 100, 100, 100, 100, 100, 4, 0, 0, 2, '2023-11-04 05:09:13'),
(86, 3, 'ACABAAADABAAAAABBBCAEAAACAAACB', 100, 100, 100, 86, 97, 29, 1, 0, 1, '2023-12-27 02:22:39');
...
(13, 16, 'ADAB', 4, 0, 100, 100, 100, 100, 100, 0, 1, '2023-11-04 02:30:07'),
(14, 16, 'AEEBABABABBC', 12, 0, 100, 100, 100, 100, 100, 0, 2, '2023-11-04 06:36:32'),
(16, 16, 'AAABABAA', 8, 0, 100, 100, 100, 100, 100, 0, 3, '2023-11-04 07:14:49'),
(18, 16, 'AAAE', 4, 0, 100, 100, 100, 100, 100, 0, 4, '2023-11-04 08:08:20'),
(20, 11, 'AAAAB', 3, 2, 60, 100, 50, 100, 0, 0, 4, '2023-11-20 20:38:06'),
(24, 3, 'ADAADA', 6, 0, 100, 100, 100, 100, 100, 0, 1, '2023-11-25 06:21:40'),
(25, 3, 'AEABAABABBCBBDDAADC', 16, 3, 84, 100, 100, 80, 60, 0, 2, '2023-12-06 16:35:09');
...
--
-- Dumping data for table `tb_hasilrefleksi`
--

INSERT INTO `tb_hasilrefleksi` (`id_refleksi`, `id_pertemuan`, `seberapa_paham`, `seberapa_baik`, `seberapa_sulit`, `seberapa_cukup`, `penghambat`, `saran`, `komentar`, `id_siswa`) VALUES
(3, 1, 'paham_sebagian', 'baik', 'sulit', 'cukup', 'G ada', 'Sudah baik lanjutkan Pa', 'bagus', 3);
...
INSERT INTO `tb_hasiltugas` (`id_hasiltugas`, `nilai`, `id_pertemuan`, `id_siswa`, `komentar`, `penilaian`, `penilaian_sikap`, `nilai_sikap`, `text`, `upload`, `created_at`, `updated_at`, `scored_at`, `memahami_masalah`, `merencanakan_pemecahan_masalah`, `melaksanakan_pemecahan_masalah`, `memeriksa_kembali`) VALUES
(53, 100, 1, 14, 'keren bro', ' 1a: 4 1b: 4 1c: 4 2a: 4 2b: 4 3: 4 4a: 4 4b: 4 ', ' Berpikir Kritis: 4 Kreatif: 4 Mandiri: 4 ', 100, '', '3f1da01d781938ad969da5379f6742b9.pdf', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '2023-12-08 03:11:04', 100, 100, 100, 100),
(63, 100, 4, 16, '', '', '', 0, 'tes', 'aaf72886eee2ed76370e99922aef83a8.pdf', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL),
(65, 94, 1, 16, 'Baik, tapi harusya diupload ke classroom untuk tugas ini jika jawabannya ini', ' 1a: 4 1b: 3 1c: 4 2a: 4 2b: 3 3: 4 4a: 4 4b: 4 ', ' Berpikir Kritis: 4 Kreatif: 4 Mandiri: 4 ', 100, 'Ini tugas Pertemuan 1 ya bang', '0117976242289395c09886aaf5c32e63.pdf', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '2023-12-07 05:08:45', 92, 88, 100, 100),
(67, 100, 3, 16, '', '', '', 0, 'Pertemuan 3', '7cad9a792639ad06a8dd6048c0dc213b.pdf', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL),
(68, 100, 2, 16, '', '', '', 0, '', 'b0d5549652faf0aa13160e8f9b4fb5ca.pdf', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL),
(73, 97, 1, 3, 'Ok bagus', ' 1a: 4 1b: 3 1c: 4 2a: 4 2b: 4 3: 4 4a: 4 4b: 4 ', ' Berpikir Kritis: 4 Kreatif: 4 Mandiri: 4 ', 100, 'Pa ini perbaikan saya ', 'c2a5a492846ffcea30bd417b42641300.pdf', '0000-00-00 00:00:00', '2023-07-23 06:44:15', '2023-12-08 03:13:01', 92, 100, 100, 100),
(81, 100, 2, 3, '', '', '', 0, 'tes', '4bdb8fe0c784cd88aa23289ef38792f0.pdf', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '2023-09-07 05:33:09', NULL, NULL, NULL, NULL),
(85, NULL, 4, 11, NULL, '', '', 0, 'ya', 'a18da55967b70758fadded8c78bf55ed.pdf', '2023-11-20 20:36:58', NULL, NULL, NULL, NULL, NULL, NULL),
(86, NULL, 4, 3, NULL, NULL, NULL, NULL, 'pa', 'dc27cc569e85b88dce3a8131060858ae.pdf', '2023-11-27 21:08:33', NULL, NULL, NULL, NULL, NULL, NULL);
...
(2, 3, 97, NULL, 97, 100, NULL, NULL, 100, 84, NULL, NULL),
(3, 14, NULL, NULL, 100, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(4, 16, 100, 100, 94, 100, 100, 100, 100, 100, 100, 100),
(5, 11, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 60),
...
(91, 3, 11, 'tes', '2023-10-24 03:16:08'),
(92, 2, 16, 'tes', '2023-10-24 03:38:53'),
(93, 3, 2, 'tes', '2023-10-28 14:28:10'),
(94, 2, 3, '#include <string><br>', '2023-10-30 13:23:34'),
(95, 3, 2, 'Pak', '2023-10-31 03:23:01'),
(96, 11, 3, 'Tes', '2023-11-13 05:18:09'),
(97, 11, 2, 'tes', '2023-11-21 03:39:07');
...
--
ALTER TABLE `tb_attempttest`
  MODIFY `id_attempt` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `tb_comments`
--
ALTER TABLE `tb_comments`
  MODIFY `id_comment` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;

--
-- AUTO_INCREMENT for table `tb_globalchat`
--
ALTER TABLE `tb_globalchat`
  MODIFY `id_globalchat` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT for table `tb_groupchat`
--
ALTER TABLE `tb_groupchat`
  MODIFY `id_groupchat` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT for table `tb_hasilapersepsi`
--
ALTER TABLE `tb_hasilapersepsi`
  MODIFY `id_hasilapersepsi` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `tb_hasilprepost`
--
ALTER TABLE `tb_hasilprepost`
  MODIFY `id_hasiltest` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;

--
-- AUTO_INCREMENT for table `tb_hasilquiz`
--
ALTER TABLE `tb_hasilquiz`
  MODIFY `id_hasilquiz` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `tb_hasilrefleksi`
--
ALTER TABLE `tb_hasilrefleksi`
  MODIFY `id_refleksi` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tb_hasiltugas`
--
ALTER TABLE `tb_hasiltugas`
  MODIFY `id_hasiltugas` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
...
--
ALTER TABLE `tb_pesan`
  MODIFY `id_pesan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;
...
--
ALTER TABLE `tb_random`
  MODIFY `id_random` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=450;
