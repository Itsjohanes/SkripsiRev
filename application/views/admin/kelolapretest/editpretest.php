        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="row">
                    <div class="col">
                        <div class="input-group input-group-outline">
                        <img src="<?= base_url('assets/img/opsipretest/' . $soal['opsi_a']); ?>" width="100px" id = "gambar_a" alt="Gambar Opsi A">
                    </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col">
                        <div class="input-group input-group-outline">
                        <img src="<?= base_url('assets/img/opsipretest/' . $soal['opsi_b']); ?>" width="100px" id = "gambar_b" alt="Gambar Opsi B">
                    </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col">
                        <div class="input-group input-group-outline">
                        <img src="<?= base_url('assets/img/opsipretest/' . $soal['opsi_c']); ?>" width="100px" id = "gambar_c" alt="Gambar Opsi C">
                    </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col">
                        <div class="input-group input-group-outline">
                        <img src="<?= base_url('assets/img/opsipretest/' . $soal['opsi_d']); ?>" width="100px" id = "gambar_d" alt="Gambar Opsi D">
                    </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col">
                        <div class="input-group input-group-outline">
                        <img src="<?= base_url('assets/img/opsipretest/' . $soal['opsi_e']); ?>" width="100px" id = "gambar_e" alt="Gambar Opsi E">
                    </div>
                    </div>
                </div>
                <div class="row">
