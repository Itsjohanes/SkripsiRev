    ...
    <div class="container mt-5">
        ...
        <ul>
            <?php foreach($files as $file): ?>
                <li><?= $file ?> <a href="<?= base_url($base_url_delete) . $file?>" class="btn btn-danger btn-sm">Hapus</a><a href="<?= base_url('filemanager/download/'.$kelompok['kelompok'].'/'.$file) ?>" class="btn btn-success btn-sm">Unduh</a></li>
