        ...
        <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                    <h6 class="text-white text-capitalize ps-3">Rapot Posttest </h6>
                </div>
            </div>
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <td>
                                    <?php
                                    if ($posttest != null) {
                                        echo $posttest['memahami_masalah'];
                                    } else {
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    if ($posttest != null) {
                                        echo $posttest['merencanakan_pemecahan_masalah'];
                                    } else {
                                        echo "Belum Mengikuti Posttest";
                                    }
                                    ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    if ($posttest != null) {
                                        echo $posttest['melaksanakan_pemecahan_masalah'];
                                    } else {
                                        echo "Belum Mengikuti Posttest";
                                    }
                                    ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    if ($posttest != null) {
                                        echo $posttest['memeriksa_kembali'];
                                    } else {
                                        echo "Belum Mengikuti Posttest";
                                    }
                                    ?>
