              ...
              <label class="radio">
                <input name="pilihan[<?php echo $data['id_soal'] ?>]" type="radio" value="A" onclick="saveSelectedOption(<?php echo $data['id_soal'] ?>, 'opsi_a')">
                  <?php if (!empty($data['opsi_a'])) : ?>
                       <?php if (file_exists('assets/img/opsiposttest/' . $data['opsi_a'])) : ?>
                       <img src="<?= base_url('assets/img/opsiposttest/' . $data['opsi_a']); ?>" width="200px" alt="Gambar Opsi A">
                    <?php else : ?>
              ...
              <label class="radio">
                <input name="pilihan[<?php echo $data['id_soal'] ?>]" type="radio" value="B" onclick="saveSelectedOption(<?php echo $data['id_soal'] ?>, 'opsi_b')">
                  <?php if (!empty($data['opsi_b'])) : ?>
                       <?php if (file_exists('assets/img/opsiposttest/' . $data['opsi_b'])) : ?>
                       <img src="<?= base_url('assets/img/opsiposttest/' . $data['opsi_b']); ?>" width="200px" alt="Gambar Opsi B">
                    <?php else : ?>
              ...
              <label class="radio">
                <input name="pilihan[<?php echo $data['id_soal'] ?>]" type="radio" value="C" onclick="saveSelectedOption(<?php echo $data['id_soal'] ?>, 'opsi_c')">
                  <?php if (!empty($data['opsi_c'])) : ?>
                       <?php if (file_exists('assets/img/opsiposttest/' . $data['opsi_c'])) : ?>
                       <img src="<?= base_url('assets/img/opsiposttest/' . $data['opsi_c']); ?>" width="200px" alt="Gambar Opsi C">
                    <?php else : ?>
              ...
              <label class="radio">
                <input name="pilihan[<?php echo $data['id_soal'] ?>]" type="radio" value="D" onclick="saveSelectedOption(<?php echo $data['id_soal'] ?>, 'opsi_d')">
                  <?php if (!empty($data['opsi_d'])) : ?>
                       <?php if (file_exists('assets/img/opsiposttest/' . $data['opsi_d'])) : ?>
                       <img src="<?= base_url('assets/img/opsiposttest/' . $data['opsi_d']); ?>" width="200px" alt="Gambar Opsi D">
                    <?php else : ?>
              ...
              <label class="radio">
                <input name="pilihan[<?php echo $data['id_soal'] ?>]" type="radio" value="E" onclick="saveSelectedOption(<?php echo $data['id_soal'] ?>, 'opsi_e')">
                  <?php if (!empty($data['opsi_e'])) : ?>
                       <?php if (file_exists('assets/img/opsiposttest/' . $data['opsi_e'])) : ?>
                       <img src="<?= base_url('assets/img/opsiposttest/' . $data['opsi_e']); ?>" width="200px" alt="Gambar Opsi E">
                    <?php else : ?>
