...
<body>
    <div class="container">
        ...
        <h2>Add Comment</h2>
        <form action="<?php echo site_url('HalamanKomentar2/save_comment'); ?>" method="post">
            ...
            <div class="comment-container">
                <div class="comment">
                    ...
                    <div class="reply-form-container" style="display: none;">
                        <form action="<?php echo site_url('HalamanKomentar2/save_reply'); ?>" method="post" class="reply-form">
                            <div class="form-group">
                                <input type="hidden" name="id_user" value = "<?php echo $user['id'];?>" required class="form-control">
                            </div>
                            <div class="form-group">
