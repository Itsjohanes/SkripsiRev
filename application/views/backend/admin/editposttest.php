...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <?php echo form_open_multipart('Admin/runEditPostTest'); ?>
        <div class="form-group">
            <input type="hidden" class="form-control" id="id_posttest" name="id_posttest" value="<?php echo $soal['id_posttest'];  ?>">
