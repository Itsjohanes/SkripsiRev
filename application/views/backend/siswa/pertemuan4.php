                 ...
                 <div class="card mb-4">
                     <div class="card-header">
                         <?= $this->session->flashdata("message");
                            ?>
                         <h6 class="m-0 font-weight-bold text-primary">Form Pengumpulan Tugas 4</h6>
                     </div>
         ...
         <div class="col-lg-6">
             ...
             <div class="card shadow mb-4">
                 ...
                 <!-- Card Body -->
                 <div class="card-body">
                     <a href='<?= base_url('materi/pertemuan4/') ?>' target='_blank'><i class="fas fa-book"> Materi</i></a>
                     &nbsp
                     <a href='<?= base_url('assets/tugas/') . $tugas['tugas']; ?>' target='_blank'><i class="fas fa-tasks"> Tugas</i></a>
                     &nbsp
                    <a href='<?= base_url('Comments4'); ?>' ><i class="fas fa-comment"> Komentar</i></a>
                 </div>
             </div>
