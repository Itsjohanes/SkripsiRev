                 ...
                 <div class="card mb-4">
                     ...
                     <?php
                        ...
                        if ($banyakHasilTugas > 0) {
                            ...
                            echo '<input type = "text" name = "pertemuan" value = "2" class = "input-group input-group-outline mb-3" readonly>';
                            echo '</div>';
                            echo '<div class="form-group">';
         ...
         <div class="col-lg-6">
             ...
             <div class="card shadow mb-4">
                 ...
                 <!-- Card Body -->
                 <div class="card-body">
                     <a href='<?= base_url('materi/pertemuan2'); ?>' target='_blank'><i class="fas fa-book"> Materi</i></a>
                     &nbsp
