...
class Comments1_model extends CI_Model {
    ...
    public function get_comments() {
        ...
        $query = $this->db->query("SELECT c.id, c.id_user, c.comment, a.nama FROM tb_comments AS c JOIN tb_akun AS a ON c.id_user = a.id WHERE c.parent_id = 0 and c.pertemuan = 1");
