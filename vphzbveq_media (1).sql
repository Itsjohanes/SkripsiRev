...
CREATE TABLE `tb_hasilapersepsi` (
  `id_hasilapersepsi` int(11) NOT NULL,
  `id_siswa` int(11) NOT NULL,
  `id_pertemuan` int(11) NOT NULL,
  `jawaban` text NOT NULL,
  `orientasi` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tb_hasilprepost` (
  `id_hasiltest` int(11) NOT NULL,
  `id_siswa` int(11) NOT NULL,
  `jawaban` text NOT NULL,
  `memahami_masalah` int(11) NOT NULL,
  `merencanakan_pemecahan_masalah` int(11) NOT NULL,
  `melaksanakan_pemecahan_masalah` int(11) NOT NULL,
  `memeriksa_kembali` int(11) NOT NULL,
...
CREATE TABLE `tb_hasilrefleksi` (
  `id_refleksi` int(11) NOT NULL,
  `id_pertemuan` int(11) NOT NULL,
  `seberapa_paham` text NOT NULL,
...
CREATE TABLE `tb_hasiltugas` (
  ...
  `penilaian_sikap` text DEFAULT NULL,
  ...
  `memahami_masalah` int(11) DEFAULT NULL,
  `merencanakan_pemecahan_masalah` int(11) DEFAULT NULL,
  `melaksanakan_pemecahan_masalah` int(11) DEFAULT NULL,
  `memeriksa_kembali` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(16, 1, 'Pertemuan_1_Percabangan_Tunggall.pdf'),
(18, 2, 'Pertemuan_2_Percabangan_Dua_Tiga_Switchh.pdf'),
(19, 3, 'Pertemuan 3_Perulangan_For_Whilee.pdf'),
(20, 4, 'Pertemuan_4_Perulangan_Do_Whilee.pdf');
...
(1, 1, 'Pada pertemuan pertama kita akan membahas jenis-jenis percabangan dan percabangan tunggal', 1, 'Siswa mampu menentukan solusi permasalahan dengan percabangan tunggal, Siswa mampu menerapkan percabangan satu kasus untuk menyelesaikan permasalahan, Siswa mampu memanipulasi percabangan satu kasus untuk menyelesaikan permasalahan \n', 'percabangantunggal.png', 'Apakah Anda pernah mendengar mengenai percabangan tunggal dan apa itu percabangan dan bagaimana percabangan tunggal menurut anda?', '2024-01-15 16:10:00'),
(2, 2, 'Pada pertemuan kedua kita akan membahas percabangan dua kasus, tiga kasus atau lebih, dan switch', 0, 'Siswa mampu menentukan solusi permasalahan dengan percabangan dua kasus, Siswa mampu menerapkan percabangan dua kasus untuk menyelesaikan permasalahan, Siswa mampu memanipulasi percabangan dua kasus untuk menyelesaikan permasalahan, Siswa mampu menentukan solusi permasalahan dengan percabangan  tiga kasus/lebih, Siswa mampu menerapkan percabangan tiga kasus / lebih untuk menyelesaikan permasalahan, Siswa mampu memanipulasi percabangan tiga kasus / lebih untuk menyelesaikan permasalahan, Siswa mampu menentukan solusi permasalahan dengan percabangan switch, Siswa mampu menerapkan switch , Siswa mampu memanipulasi percabangan switch untuk menyelesaikan permasalahan', 'percabanganduakasus.png', 'Apakah Anda pernah mendengar percabangan dua kasus, tiga kasus, dan switch, jika pernah bagaimana perbedaannya?', '2024-01-16 16:03:31'),
(3, 3, 'Pada pertemuan ketiga kita akan membahas jenis-jenis perulangan ,perulangan for, dan while', 0, 'Siswa mampu menentukan solusi permasalahan dengan perulangan for,  Siswa mampu menerapkan perulangan for untuk menyelesaikan permasalahan, Siswa mampu memanipulasi perulangan for untuk menyelesaikan permasalahan, Siswa mampu menentukan solusi permasalahan dengan perulangan while, Siswa mampu menerapkan perulangan while untuk menyelesaikan permasalahan, Siswa mampu memanipulasi perulangan while untuk menyelesaikan permasalahan', 'perulanganwhile.png', 'Apakah anda pernah mendengar perulangan for dan while, jika pernah kira-kira bagaimana perbedaannya?', '2024-01-22 16:48:18'),
(4, 4, 'Pada pertemuan keempat kita akan mempelajari perulangan do while', 0, 'Siswa mampu menentukan solusi permasalahan dengan perulangan do while, Siswa mampu menerapkan perulangan do while untuk menyelesaikan permasalahan, Siswa mampu memanipulasi perulangan do while untuk menyelesaikan permasalahan', 'perulangandowhile.png', 'Apakah anda pernah mendengar perulangan do while, jika pernah kira-kira bagaimana perbedaan dengan perulangan sebelum-sebelumnya?', '2024-01-23 16:48:00');
...
(1, 'Seorang programmer ingin membuat program dalam bahasa C++  yang akan mencetak angka-angka bilangan bulat dari 1 hingga 10 secara lengkap. Program tersebut akan menggunakan perulangan untuk mencetak angka-angka tersebut. Penamaan variable dibebaskan. Apa contoh data yang diketahui dan apakah data-data yang diberikan sudah cukup bagi programmer untuk menentukan bahwa perulangan for adalah yang paling tepat?', '', ' Perulangan mencetak 1 sampai 10 dan cukup ', ' Perulangan mencetak 1 sampai 10 dan kontradiktif  ', ' Perulangan mencetak 1 sampai 10 dan belum cukup  ', 'Perulangan mencetak 1 sampai 10 dan berlebihan ', 'Tidak ada konteks yang jelas', 'A', 1, 1),
(2, 'Seorang kandidat ingin diterima di sebuah perusahaan. Syarat yang harus dipenuhi adalah memiliki ijazah sarjana atau setidaknya dua tahun pengalaman kerja. Jika syarat ini terpenuhi, maka program akan mengeluarkan output \"Anda diterima.\" Jika syarat tidak terpenuhi, program akan mengeluarkan output \"Maaf, Anda tidak memenuhi syarat.\" Bagaimana potongan kode C++ dan Scratch yang paling tepat untuk kasus ini jika diketahui flowchart diagramnya adalah sebagai berikut?', '2_soal.PNG', '2_a.PNG', '2_b.PNG', '2_c.PNG', '2_d.PNG', '2_e.PNG', 'E', 1, 3),
(3, 'Sebuah program akan menentukan jenis buah berdasarkan kode buah yang diberikan pengguna. Pengguna akan memasukkan kode buah (A untuk \"Apel\", B untuk \"Belimbing\", J untuk \"Jeruk\", kode lainnya untuk “Tidak diketahui”). Bagaimana potongan kode C++ yang sesuai dengan penggunaan switch untuk menentukan jenis buah berdasarkan kode yang dimasukkan pengguna jika diberikan flowchart sebagai berikut?', '3_soal.PNG', '3_a.PNG', '3_b.PNG', '3_c.PNG', '3_d.PNG', '3_e.PNG', 'A', 1, 3),
(4, 'Sebuah Program ditujukan untuk menentukan apakah seseorang itu remaja, dewasa, atau lansia, Jika umur seseorang kurang dari 18 tahun maka dia adalah remaja jika umur seseorang 18 tahun sampai 59 tahun maka ia adalah dewasa dan jika lebih dari 59 maka seseorang lansia. Bagaimana dan apa yang harus dilengkapi  agar code program berjalan sesuai dengan yang diinginkan dan code yang dipilih juga harus yang paling hemat penulisannya?', '4_soal.PNG', 'Pada kondisi else pertama tambahkan if(usia >=18 && usia < 60)', 'Pada kondisi else pertama tambahkan if(usia >=18 && usia < 60) dan tambahkan pada else kedua if(usia >= 60)', 'Pada kondisi else pertama tambahkan if(usia < 60)', 'Pada kondisi else pertama tambahkan if(usia < 60) dan tambahkan pada else kedua if(usia >= 60)', 'Tambahkan pada else kedua if(usia >= 60)', 'C', 1, 4),
(5, 'Buatlah program dalam C++ yang menggunakan perulangan for untuk mencetak deret bilangan dari 10 hingga 50 dengan increment 2 Jika diberikan flowchart sebagai berikut.', '5_soal.PNG', '5_a.PNG', '5_b.PNG', '5_c.PNG', '5_d.PNG', '5_e.PNG', 'A', 1, 3),
(6, 'Seorang pelanggan restoran memesan makanan. Jika pelanggan memesan \"Mie Goreng,\" maka harga makanan yang dipesan didiskon 2500 rupiah. Namun, jika pelanggan tidak memesan \"Mie Goreng,\" maka harga makanan tidak akan didiskon (dikurangi 0 rupiah tetap ditulis). Penamaan variable dibebaskan. Jenis percabangan yang digunakan dalam situasi ini jika menggunakan bahasa pemrograman C++ maupun Scratch dan Bagaimana gambaran flowchartnya?', '', '6_a.PNG', '6_b.PNG', '6_c.PNG', '6_d.PNG', '6_e.PNG', 'D', 1, 2),
...
(8, 'Seorang guru akan memberikan nilai berdasarkan performa siswa dalam ujian. Jika nilai lebih besar atau sama dengan 90, maka siswa tersebut akan mendapatkan nilai A. Jika nilai 70 hingga 89, dia akan mendapatkan nilai B. Jika nilai kurang dari 70, dia akan mendapatkan nilai C. Bagaimana potongan kode C++ yang paling tepat untuk kasus ini jika flowchart diagramnya sebagai berikut?', '8_soal.PNG', '8_a.PNG', '8_b.PNG', '8_c.PNG', '8_d.PNG', '8_e.PNG', 'A', 1, 3),
(9, 'Andi ingin membuat program yang mencetak bilangan bulat dari 1 hingga 10 dengan variable i. Apa perulangan yang paling sesuai dan bagaimana gambaran flowchart yang paling sesuai dengan kasus ini jika bahasa pemrograman yang nanti digunakan adalah C++?', '', '9_a.PNG', '9_b.PNG', '9_c.PNG', '9_d.PNG', '9_e.PNG', 'A', 1, 2),
...
(12, 'Seorang pelanggan restoran ingin menentukan menu makan malam yang akan dipesan berdasarkan kode pada menu. Jika kode adalah A, pelanggan akan memesan \"Nasi Goreng.\" Jika kode adalah B, pelanggan akan memesan \"Steak.\" Jika kode adalah C, pelanggan akan memesan \"Sushi.\" Jika kode yang dimasukan tidak sesuai maka menampilkan “Kode yang dimasukan tidak sesuai”. Penamaan variable dibebaskan. Apa percabangan yang paling sesuai dan hemat code dan Bagaimana flowchartnya dalam bahasa C++?', '', '12_a.PNG', '12_b.PNG', '12_c.PNG', '12_d.PNG', '12_e.PNG', 'A', 1, 2),
(13, 'Seorang guru ingin menentukan siswa mana yang memiliki nilai tertinggi dalam sebuah kelas. Guru tersebut mengetahui bahwa terdapat empat siswa yang bernama M, N, O, dan P. Guru tersebut juga mengetahui bahwa nilai siswa M adalah 78, siswa N adalah 92, siswa O adalah 86, dan siswa P adalah 90. Penamaan variable dibebaskan. Apa contoh data yang diketahui dan apakah data-data yang diberikan untuk menentukan jenis percabangan yang digunakan adalah percabangan tiga kasus atau lebih dipilih jika menggunakan bahasa C++?', '', ' Diketahui data nilai siswa salah satunya adalah siswa M dengan nilai 78 dan cukup ', ' Diketahui data nilai siswa salah satunya adalah siswa N dengan nilai 92 kontradiktif  ', ' Diketahui data nilai siswa salah satunya adalah siswa M dengan nilai 78 dan berlebihan  ', 'Diketahui data nilai siswa dua diantaranya  adalah siswa N dengan nilai 92 &amp; siswa P dengan nilai 90 dan tidak cukup ', 'Tidak ada konteks yang jelas', 'A', 1, 1),
(14, 'Anda ingin membuat program yang meminta pengguna untuk menginputkan bilangan-bilangan positif dan bilangan nol hingga pengguna memasukkan bilangan negatif. Progam tersebut akan melakukan pengecekan di awal. Jika dimasukan bilangan negatif di awal maka blok perulangan tidak dikerjakan. Program akan mencetak jumlah dari bilangan-bilangan tersebut jika diberikan flowchart sebagai berikut.', '14_soal.PNG', '14_a.PNG', '14_b.PNG', '14_c.PNG', '14_d.PNG', '14_e.PNG', 'A', 1, 3),
(15, 'Seorang karyawan ingin mengajukan cuti. Jika karyawan tersebut memiliki sisa cuti lebih dari atau sama dengan 10 hari, maka permohonan cuti akan disetujui. Tidak ada aksi lainnya. Penamaan variable dibebaskan. Apa percabangan yang sesuai dan bagaimana potongan flowchart jika nanti program yang dibuat dalam bahasa C++/Scratch?', '', '15_a.PNG', '15_b.PNG', '15_c.PNG', '15_d.PNG', '15_e.PNG', 'A', 1, 2),
(16, 'Rahma ingin membuat program dalam bahasa C++ yang menghitung total belanja saat berbelanja online. Program tersebut akan terus mengulang minimal satu kali hingga pengguna memasukkan angka nol sebagai tanda akhir pembelian. Pengecekan perulangan dilakukan di awal sebelum masuk ke blok perulangan. Penamaan variable dibebaskan. Apa contoh data yang diketahui dan apakah data-data yang diberikan ini sudah cukup bagi Rahma untuk menentukan bahwa bahwa perulangan yang digunakan adalah do while?', '', ' Perulangan minimal dilakukan satu kali dan kontradiktif ', ' Perulangan berhenti ketika dimasukan angka nol dan dan belum cukup ', ' Perulangan minimal dilakukan satu kali dan Dan berlebihan ', 'Tidak ada konteks yang jelas', 'Perulangan minimal dilakukan satu kali dan cukup', 'A', 1, 1),
(17, 'Doni ingin membuat suatu program untuk mengecek apakah suatu bilangan itu bilangan ganjil atau genap. Doni menginginkan program mengulang minimal satu kali dan berhenti jika inputan bernilai 0, namun nyatanya program telah selesai ketika Doni mengisikan angka 0 program tidak mengulang. Bagaimana caranya untuk memperbaiki code Doni?', '17_soal.PNG', 'Ubah perulangan while menjadi do while dan tambahkan kondisi else pada if “Bilangan ganjil”', 'Ubah perulangan while menjadi do while dan tambahkan kondisi else pada if cout<<“Bilangan ganjil” dan ubah juga aksi pada if cout<<”Bilangan genap”', 'Tambahkan kondisi else pada if cout<<“Bilangan ganjil” dan ubah juga aksi pada if cout<<”Bilangan genap”', 'Tambahkan kondisi else pada if cout<<“Bilangan ganjil”', 'Ubah juga aksi pada if cout<<”Bilangan genap”', 'B', 1, 4),
(18, 'Seorang siswa ingin membuat program yang menentukan makanan yang akan dia makan berdasarkan kondisi cuaca. Jika cuaca adalah cerah, output \"dia akan makan salad\". Penamaan variable dibebaskan. Apa contoh data yang diketahui dan apakah data-data yang diberikan sudah cukup untuk membuat program untuk menggambarkan bahwa percabangan yang digunakan adalah percabangan dua kasus jika menggunakan bahasa pemrograman C++ maupun Scratch?', '', 'Jika cerah maka makan salad dan sudah cukup', 'Jika cerah maka makan salad dan belum cukup', 'Jika cerah maka makan salad dan kontradiktif', 'Jika cerah maka makan salad dan berlebihan', 'Tidak ada konteks yang jelas', 'B', 1, 1),
(19, 'Miftah ingin membuat suatu aplikasi dalam bahasa C++/Scratch yang menerapkan prinsip perulangan yang diketahui batas awalnya. Penamaan variable dibebaskan. Apa contoh data yang diketahui dan apakah data-data yang diberikan sudah cukup untuk miftah menentukan bahwa perulangan while (pada c++) / repeat until (pada scratch) yang dibutuhkan?\r\n', '', 'Batas awal perulangan diketahui  diketahui dan cukup', ' Batas akhir diketahui dan kontradiktif ', ' Batas awal diketahui dan belum cukup ', 'Batas akhir diketahui dan berlebihan ', 'Tidak ada konteks yang jelas', 'C', 1, 1),
(20, 'Evan ingin membuat program untuk memeriksa apakah sebuah bilangan itu ganjil atau genap. Jika bilangannya ganjil program akan mencetak bilangan/5 sedangkan jika genap program akan mencetak bilangan / 2. Apa yang perlu dilengkapi dari code di bawah ini jika bilangan awal adalah 10?', '20_soal.PNG', 'Pada kondisi if tambahkan a % 2 == 0 pada kode c++ dan a mod 2  = 0 pada Scratch', 'Pada kondisi if tambahkan a % 2 != 0 pada kode c++ dan not a mod 2  = 0 pada Scratch', 'Pada kondisi if tambahkan a % 2 == 0 pada kode c++ dan a mod 2  = 0 pada Scratch dan tambahkan kondisi else berupa cout<<a/5 pada C++ dan say a/5', 'Pada kondisi if tambahkan a % 2 != 0 pada kode c++ dan not a mod 2  = 0 pada Scratch dan tambahkan kondisi else berupa cout<<a/5 pada C++ dan say a/5', 'Kode tidak perlu ditambahkan', 'C', 1, 4),
(21, 'Andi ingin membuat program dalam bahasa C++ yang meminta pengguna memasukkan angka-angka positif. Program akan terus meminta input angka dari pengguna hingga pengguna memasukkan angka negatif. Jika angka yang dimasukkan adalah bilangan ganjil, program akan mencetak \"Ganjil\". Penamaan variable dibebaskan. Perulangan minimal dilakukan satu kali. Apa contoh data yang diketahui dan apakah data-data yang diberikan untuk menentukan bahwa perulangan yang digunakan adalah do while?', '', ' Perulangan minimal dilakukan satu kali dan cukup ', ' Perulangan berhenti ketika dimasukan angka negatif dan kontradiktif ', ' Perulangan minimal dilakukan satu kali dan dan belum cukup ', 'Perulangan berhenti ketika dimasukan angka negatif dan berlebihan ', 'Tidak ada konteks yang jelas', 'A', 1, 1),
(22, 'Rani ingin membuat program dalam bahasa C++ yang akan meminta pengguna memasukkan angka-angka positif dan angka nol. Program akan terus meminta input angka dari pengguna hingga pengguna memasukkan angka negatif. Jika angka yang dimasukkan adalah bilangan genap, program akan mencetak \"Genap.\" Perulangan minimal dilakukan satu kali. Penamaan variable dibebaskan. Jenis perulangan apa yang paling cocok untuk digunakan dalam kasus ini?', '', '22_a.png', '22_b.PNG', '22_c.PNG', '22_d.PNG', '22_e.PNG', 'A', 1, 2),
(23, 'Seorang pengguna aplikasi streaming ingin menonton film. Ada tiga film yang tersedia. Jika ada harga sewa yang sama jadikan salah satu sebagai patokan. Penamaan variable dibebaskan. Bagaimana potongan flowchart jika nanti menggunakan bahasa C++  untuk mencari aplikasi yang paling murah dan mencetak outputnya?', '', '23_a.PNG', '23_b.PNG', '23_c.PNG', '23_d.PNG', '23_e.PNG', 'A', 1, 2),
(24, 'Andre ingin membuat sebuah program untuk percabangan tunggal untuk memeriksa apakah suatu bilangan a itu habis dibagi b atau tidak, bagaimana agar kode ini dapat berjalan sesuai dengan apa yang andra mau dengan melengkapi kode yang hilang?', '24_soal.PNG', 'Pada code C++ lengkapi kondisi percabangan a % b != 0 dan pada Scratch not a mod b = 0', 'Pada code C++ lengkapi kondisi percabangan a % b == 0 dan pada Scratch a mod b = 0', 'Pada code C++ lengkapi kondisi percabangan b % a != 0 dan pada Scratch not b mod a= 0', 'Pada code C++ lengkapi kondisi percabangan b % a == 0 dan pada Scratch b mod a = 0', 'Pada code C++ lengkapi kondisi percabangan umur a % b == 0 dan pada Scratch a mod b = 0 dan buatkan kondisi else nya pada c++ tambahkan cout<<”a tidak habis dibagi b” dan pada Scratch tambahkan say a tidak habis dibagi b', 'B', 1, 4),
(25, 'Stefen sedang mempelajari pemrograman, Pada suatu ketika stefen sedang mempelajari materi switch, Stefen membuat program jika angka yang dideklarasikan stefen bernilai 1 maka keluarnya adalah SatuDua, perhatikan dua kode tersebut. pa yang harus stefen lakukan agar jika pilihan bernilai 1 maka menghasilkan output SatuDua ?', '25_soal.PNG', 'Pada code pertama hapus break sebelum case 2 agar blok program yang dikerjakan selesai pada case 2 jika memasukan angka 1', 'Pada code kedua hapus break sebelum case 3 agar blok program yang dikerjakan selesai pada case 3 jika memasukan angka 1', 'Pada code pertama hapus break sebelum case 2 dan pada code kedua tambahkan break sebelum  case 3 agar blok program yang dikerjakan selesai pada case 2 jika memasukan angka 1', 'Hapus code default karena tidak diperlukan', 'Pada code kedua tambahkan break sebelum code ketiga agar blok program yang dikerjakan selesai pada case 2 jika memasukan angka 1', 'C', 1, 4),
...
(27, 'Hafil adalah seorang pencinta anime. Suatu ketika hafil hendak menentukan pilihan anime yang akan ditontonnya jika ditentukan bahwa hari senin adalah 1 dan \"ia menonton naruto\", selasa adalah 2 dan \"ia menonton one piece\", rabu adalah 3 dan \"ia menonton boruto\", dan mengulang lagi sampai hari ke-7. Jika memasukan angka yang tidak valid misalnya angka 8 keatas maka menghasilkan output tidak valid. Penamaan variable dibebaskan. Apa contoh data yang diketahui dan apakah data-data yang diberikan sudah cukup untuk menentukan bahwa percabangan yang paling tepat adalah switch? (Asumsinya kode ditulis dalam bahasa C++)', '', 'Diketahui bahwa dalam menentukan anime yang ditontonnya hafil menentukan berdasarkan hari, hari senin memiliki kode 1 dan hari selasa memiliki kode 2  dan sudah cukup', 'Diketahui bahwa dalam menentukan anime yang ditontonnya hafil menentukan berdasarkan hari, hari senin memiliki kode 1 dan hari selasa memiliki kode 2 dan belum cukup', 'Diketahui bahwa dalam menentukan anime yang ditontonnya hafil menentukan berdasarkan hari, hari senin memiliki kode 1 dan hari selasa memiliki kode 3 dan kontradiktif', 'Diketahui bahwa dalam menentukan anime yang ditontonnya hafil menentukan berdasarkan hari, hari senin memiliki kode 1 dan hari selasa memiliki kode 3 dan berlebihan', 'Tidak ada konteks yang jelas', 'A', 1, 1),
(28, 'Aji ingin membuat program dalam bahasa C++ yang akan meminta pengguna untuk memasukkan angka berupa bilangan bulat positif. Program akan terus meminta input bilangan dari pengguna hingga pengguna memasukkan bilangan nol. Asumsinya input pertama di luar blok perulangan dan pengecekan di awal. Penamaan variable dibebaskan. Kira-kira apa perulangan yang  paling sesuai dan  bagaimana gambaran flowchartnya jika ditulis dalam bahasa C++?', '', '28_a.PNG', '28_b.PNG', '28_c.PNG', '28_d.PNG', '28_e.PNG', 'A', 1, 2),
(29, 'Seorang siswa ingin lulus ujian matematika. Jika siswa tersebut mendapat nilai minimal 70 maka output program adalah “Anda lulus”.  Jika nilainya dibawah 70 maka output program “Anda tidak lulus”. Penamaan variable dibebaskan. Apa contoh data yang diketahui dan apakah data-data yang diberikan sudah dapat untuk menentukan bahwa percabangan yang digunakan adalah percabangan tunggal jika menggunakan bahasa pemrograman C++ maupun Scratch?', '', 'Jika mencapai nilai minimal 70 program dijalankan dan cukup', 'Jika mencapai nilai 70 program dijalankan dan kontradiktif', 'Jika mencapai nilai minimal 70 program dijalankan dan berlebihan', 'Jika mencapai nilai 70 program dijalankan dan tidak cukup', 'Tidak ada konteks yang jelas', 'C', 1, 1),
(30, 'Seorang siswa ingin mendaftar kuliah. Jika siswa tersebut memiliki nilai tes TOEFL lebih dari atau sama dengan 550 maka siswa tersebut dapat mendaftar ke program studi internasional. Tidak ada aksi lainnya. Penamaan variable dibebaskan. Apa percabangan yang sesuai dan bagaimana potongan flowchart jika nanti program yang dibuat dalam bahasa C++/Scratch?', '', '30_a.PNG', '30_b.PNG', '30_c.PNG', '30_d.PNG', '30_e.PNG', 'B', 1, 2),
(31, 'Elizabeth ingin membuat program dalam bahasa C++ yang melakukan penghitungan rata-rata dari sejumlah bilangan yang dimasukkan pengguna. Namun, Elizabeth hanya diketahui batas bawah dari jumlah bilangan yang akan dimasukkan pengguna. Penamaan variable dibebaskan. Apa contoh data yang diketahui dan apakah data-data yang diberikan sudah cukup bagi Elizabeth untuk menentukan bahwa jenis perulangan for merupakan perulangan yang dibutuhkan?', '', ' Elizabeth mengetahui batas bawah dari perulangan dan cukup  ', ' Elizabeth mengetahui batas bawah dari perulangan dan kontradiktif  ', ' Elizabeth mengetahui batas bawah dari perulangan dan belum cukup  ', 'Elizabeth mengetahui batas bawah dari perulangan dan berlebihan ', 'Tidak ada konteks yang jelas', 'C', 2, 1),
(32, 'Seorang kandidat ingin diterima di sebuah perusahaan. Syarat yang harus dipenuhi adalah memiliki pengalaman kerja minimal lima tahun dan memiliki ijazah magister. Jika kedua syarat ini terpenuhi, maka program akan mengeluarkan output \"Anda diterima.\" Jika tidak terpenuhi, program akan mengeluarkan output \"Maaf, Anda tidak memenuhi syarat.\" Bagaimana potongan kode C++ dan Scratch yang paling tepat untuk kasus ini? ', '2_soal.PNG', '2_a.PNG', '2_b.PNG', '2_c.PNG', '2_d.PNG', '2_e.PNG', 'A', 2, 3),
(33, 'Sebuah program akan menentukan arah mata angin berdasarkan kode arah yang diberikan pengguna. Pengguna akan memasukkan kode arah (U untuk \"Utara\", B untuk \"Barat\", S untuk \"Selatan\", kode lainnya untuk “Tidak diketahui”). Bagaimana potongan kode C++ yang sesuai dengan penggunaan switch untuk menentukan arah mata angin berdasarkan kode yang dimasukkan pengguna jika diberikan flowchart sebagai berikut?', '3_soal.PNG', '3_a.PNG', '3_b.PNG', '3_c.PNG', '3_d.PNG', '3_e.PNG', 'B', 2, 3),
(34, 'Sebuah program ditujukan untuk menentukan predikat nilai siswa. Jika nilai siswa mendapat 90 atau lebih maka nilai siswa adalah A. Jika nilai siswa 80-89 maka nilai siswa adalah B dan jika nilai siswa lebih kecil dari 80 maka nilai siswa adalah C. Apa yang harus diubah dari program dibawah ini, ubahlah dengan code yang paling efektif?', '4_soal.PNG', 'Pada else pertama tambahkan if(nilai>= 80)', 'Pada else pertama tambahkan if(nilai>80)', 'Pada else pertama tambahkan if(nilai>= 80) dan hapus kondisi else ketiga dan keempat', 'Pada else pertama tambahkan if(nilai>80) dan pada else kedua tambahkan if(nilai <80)', 'Pada else pertama tambahkan if(nilai>80) dan pada else kedua tambahkan if(nilai <80) dan hapus kondisi else ketiga dan keempat', 'C', 2, 4),
(35, 'Buatlah program dalam C++ yang menggunakan perulangan for untuk mencetak deret angka 10 hingga 100 dengan increment 5 Jika flowchartnya.', '5_soal.PNG', '5_a.PNG', '5_b.PNG', '5_c.PNG', '5_d.PNG', '5_e.PNG', 'A', 2, 3),
(36, 'Seorang pengemudi memasuki area parkir. Jika pengemudi memilih untuk parkir di zona \"Mobil Kecil\", maka biaya parkir akan menjadi 10.000 rupiah. Namun, jika pengemudi tidak memilih parkir di zona mobil kecil, maka biaya parkir akan menjadi 20.000 rupiah. Penamaan variable dibebaskan. Kira-kira percabangan apakah yang mirip dengan kasus tersebut jika menggunakan bahasa pemrograman C++ maupun Scratch?', '', '6_a.PNG', '6_b.PNG', '6_c.PNG', '6_d.PNG', '6_e.PNG', 'A', 2, 2),
...
(42, 'Seorang pengemudi taksi ingin menentukan tarif perjalanan berdasarkan zona tujuan penumpang. Jika zona adalah \'A\', maka harga tarif perjalanan adalah 50.000 rupiah. Jika zona adalah \'B\', maka harga tarif perjalanan adalah 75.000 rupiah. Jika zona adalah \'C\', maka harga tarif perjalanan adalah 100.000 rupiah. Penamaan variable dibebaskan. Apa konsep yang sesuai, hemat code dan bagaimana gambaran flowchart dari masalah ini jika program dibuat dalam bahasa C++? ', '', '12_a.PNG', '12_b.PNG', '12_c.PNG', '12_d.PNG', '12_e.PNG', 'C', 2, 2),
(43, 'Seorang koki ingin menentukan menu spesial yang akan disajikan di restorannya. Keputusan ini bergantung pada musim saat ini. Jika saat ini musim panas, menunya adalah salad; jika saat ini musim gugur, menunya adalah kari; jika saat ini musim dingin, menunya adalah hidangan sup. Penamaan variable dibebaskan. Apa contoh data yang diketahui dan apakah data-data yang diberikan sudah cukup untuk menentukan jenis percabangan tiga kasus atau lebih yang nanti akan dipilih jika menggunakan bahasa C++?', '', 'Tidak ada konteks yang jelas', ' Jika musim panas, makanan yang disajikan adalah sup dan kontradiktif  ', ' Jika musim dingin, makanan yang disajikan adalah sup dan berlebihan  ', 'Jika musim dingin, makanan yang disajikan adalah sup dan tidak cukup ', ' Jika musim panas, makanan yang disajikan adalah salad dan cukup ', 'E', 2, 1),
(44, 'Anda ingin membuat program yang meminta pengguna untuk menginputkan bilangan-bilangan hingga pengguna memasukkan bilangan 999. Program akan mencetak jumlah dari bilangan-bilangan tersebut. Pengecekan dilakukan di awal. Penamaan variable dibebaskan. Jika 999 dimasukan di awal maka blok perulangan tidak dikerjakan dan diberikan flowchart sebagai berikut.', '14_soal.PNG', '14_a.PNG', '14_b.PNG', '14_c.PNG', '14_d.PNG', '14_e.PNG', 'A', 2, 3),
(45, 'Seorang pengendara ingin memasuki tol. Jika pengendara tersebut memiliki kartu tol, maka dia dapat membayar tol dengan diskon dan tidak ada kondisi dan aksi alternatif. Penamaan variable dibebaskan. Apa jenis percabangan yang mirip jika menggunakan bahasa pemrograman C++ maupun Scratch?', '', '15_a.PNG', '15_b.PNG', '15_c.PNG', '15_d.PNG', '15_e.PNG', 'A', 2, 2),
(46, 'Arif ingin membuat program dalam bahasa C++ yang mencetak \"Selamat Datang!\" selama pengguna memasukkan huruf \"Y\" sebagai konfirmasi. Pengecekan perulangan dilakukan diawal sebelum masuk blok perulangan dan jika pengguna memasukkan huruf \"N\", perulangan tidak dilakukan dan perulangan dilakukan minimal satu kali  maka program berhenti. Penamaan variable dibebaskan. Apakah informasi ini sudah cukup bagi Arif untuk menentukan bahwa perulangan yang diperlukan adalah perulangan do-while? ', '', 'Pengecekan dilakukan di awal dan cukup', 'Pengecekan dilakukan di awal dan kontradiktif', 'Pengecekan dilakukan di awal dan dan belum cukup', 'Pengecekan dilakukan di awal dan Dan berlebihan	', 'Tidak ada konteks yang jelas', 'B', 2, 1),
(47, 'Doni ingin membuat suatu program yang bertujuan untuk menghitung total angka yang dimasukan oleh pengguna. Perulangan minimal dilakukan satu kali perulangan dan pengecekan dilakukan diakhir. Jika pada perulangan kedua dimasukan angka 999 maka program akan berhenti. Apa yang harus dilakukan oleh Doni jika Doni membuat code sebagai berikut?', '17_soal.PNG', 'Buatkan kondisi do while dengan kondisi pada while(angka != 999)', 'Buatkan while dengan kondisi pada while(angka != 999)', 'Buatkan kondisi for dengan for(int i = 1;i<=999;i++)', 'Buatkan kondisi for dengan for(int i = 1;i<999;i++)', 'Buatkan kondisi do while dengan kondisi pada while(angka == 999)', 'A', 2, 4),
(48, 'Seorang guru ingin membuat program penilaian untuk siswanya. Jika siswa mendapatkan nilai 70 atau  di atas 70, mereka akan diberikan predikat \"Lulus\". Jika nilai siswa di bawah 70, mereka akan diberikan predikat \"Tidak Lulus\". Jika nilai siswa dibawah 60 maka akan diberi predikat “Siswa Pemalas”.Penamaan variable dibebaskan. Apa contoh data yang diketahui dan apakah data-data yang diberikan sudah cukup untuk untuk menggambarkan bahwa percabangan dua kasus yang dipergunakan,  jika menggunakan bahasa pemrograman C++ maupun Scratch?', '', 'Jika mendapat nilai minimal 70 maka lulus dan sudah cukup', 'Jika mendapat nilai minimal 70 maka lulus dan belum cukup ', 'Jika mendapat nilai maksimal 70 maka lulus dan kontradiktif', 'Jika mendapat nilai minimal 70 maka lulus dan berlebihan', 'Tidak ada konteks yang jelas', 'D', 2, 1),
(49, 'Rudi ingin membuat program dalam bahasa C++/Scratch untuk menghitung nilai rata-rata dari sejumlah angka yang dimasukkan pengguna. Rudi hanya mengetahui bahwa program tersebut akan mengulangi proses penginputan angka hanya jika pengguna menginginkan untuk memasukkan lebih banyak angka. Pengecekan input pertama dilakukan di awal dan perulangan minimal dilakukan satu kali. Penamaan variable dibebaskan. Apa contoh data yang diketahui dan apakah data-data yang diberikan sudah cukup bagi Rudi untuk menentukan bahwa perulangan yang diperlukan adalah perulangan while (pada c++) /repeat until (pada scratch)?', '', 'Pengecekan input pertama dilakukan di awal dan cukup ', 'Pengecekan input pertama dilakukan di awal dan Kontradiktif ', 'Pengecekan input pertama dilakukan di awal dan belum cukup ', 'Pengecekan input pertama dilakukan di awal dan belum cukup', 'Tidak ada konteks yang jelas', 'B', 2, 1),
(50, 'Anton ingin membuat suatu aplikasi yang bertujuan untuk menentukan seseorang itu lansia atau bukan. Jika umur seseorang lebih dari 60 tahun atau 60 tahun seseorang itu Lansia dan jika tidak maka belum lansia. Bagaimana caranya agar program berjalan sesuai yang Anton mau dan code yang dipilih haruslah lebih hemat dalam penulisannya?', '20_soal.PNG', 'Lengkapi kondisi percabangan pada bagian if dengan usia>60\n\n\n', 'Lengkapi kondisi percabangan pada bagian if dengan usia>=60 pada c++ dan pada scratch usia > 60 or usia = 60', 'Lengkapi kondisi percabangan pada bagian if dengan usia != 60 pada C++ dan pada scratch not usia = 60', 'Lengkapi kondisi percabangan pada bagian if dengan usia>=60 pada c++ & if usia > 60 or usia = 60 dan lengkapi kondisi elsenya dengan else if(usia <60)', 'Lengkapi kondisi percabangan pada bagian if dengan usia>60 dan lengkapi kondisi elsenya dengan else if(usia <=60)', 'B', 2, 4),
(51, 'Andi ingin membuat program dalam bahasa C++ yang meminta pengguna memasukkan angka-angka positif. Program akan terus meminta input angka dari pengguna hingga pengguna memasukkan angka negatif. Jika angka yang dimasukkan adalah bilangan ganjil, program akan mencetak \"Ganjil\" .Perulangan minimal dilakukan satu kali. Penamaan variable dibebaskan. Apa contoh data yang diketahui dan apakah data-data yang diberikan sudah cukup untuk menentukan bahwa perulangan yang digunakan adalah do while?', '', ' Perulangan minimal dilakukan satu kali dan cukup ', ' Perulangan berhenti ketika dimasukan angka negatif dan kontradiktif ', ' Perulangan minimal dilakukan satu kali dan dan belum cukup ', 'Perulangan berhenti ketika dimasukan angka negatif dan berlebihan', 'Perulangan berhenti ketika dimasukan angka negatif dan berlebihan', 'A', 2, 1),
(52, 'Andi ingin membuat program  dalam bahasa C++  yang meminta pengguna memasukkan angka-angka positif. Program akan terus meminta input angka dari pengguna hingga pengguna memasukkan angka negatif. Perulangan mininal dilakukan satu kali. Penamaan variable dibebaskan. Jenis perulangan apa yang paling cocok untuk digunakan dalam kasus ini dan bagaimana flowchartnya?', '', '22_a.PNG', '22_b.PNG', '22_C.PNG', '22_d.PNG', '22_e.PNG', 'B', 2, 2),
(53, 'Seorang penumpang pesawat ingin memilih maskapai yang menawarkan tiket paling mahal untuk tujuan yang sama. Ada tiga maskapai yang melayani rute tersebut. Maskapai A menawarkan tiket seharga 500.000 rupiah, Maskapai B menawarkan tiket seharga 550.000 rupiah, dan Maskapai C menawarkan tiket seharga 480.000 rupiah. Penamaan variable dibebaskan. Bagaimana potongan flowchart jika nanti menggunakan bahasa C++ untuk mencari maskapai paling mahal dan mencetak outputnya?', '', '23_a.PNG', '23_b.PNG', '23_c.PNG', '23_d.PNG', '23_e.PNG', 'B', 2, 2),
(54, 'Andra ingin membuat sebuah program untuk percabangan tunggal untuk memeriksa apakah suatu bilangan itu genap atau tidak, bagaimana agar kode ini dapat berjalan sesuai dengan apa yang andra mau dengan melengkapi kode yang hilang?', '24_soal.PNG', 'Pada code C++ lengkapi kondisi percabangan umur % 2 == 0 dan pada Scratch umur mod 2 = 0', 'Pada code C++ lengkapi kondisi percabangan umur % 2 != 0 dan pada Scratch not umur mod 2 = 0', 'Pada code C++ lengkapi kondisi percabangan umur % 4 != 0 dan pada Scratch not umur mod 4 = 0', 'Pada code C++ lengkapi kondisi percabangan umur % 4 == 0 dan pada Scratch umur mod 4 = 0', 'Pada code C++ lengkapi kondisi percabangan umur % 2 == 0 dan pada Scratch umur mod 2 = 0 dan buatkan kondisi else nya pada c++ tambahkan cout<<”ganjil” dan pada Scratch tambahkan say “genap”', 'A', 2, 4),
(55, 'Doni ingin membuat suatu program menyatakan pilihan 1 sampai ke 3 jika yang dimasukan adalah angka 1 maka akan mengeluaran output “Satu” , jika yang dimasukan 2 maka outputnya “Dua” dan jika yang dimasukan adalah 3 maka outputnya adalah “Tiga” jika yang dimasukan adalah yang lain maka tidak akan muncul apa-apa, apa yang perlu diubah?', '25_soal.PNG', 'Tambahkan break pada akhir case 1 dan 2', 'Tambahkan break pada akhir case 1, 2, dan hapus kondisi default', 'Tambahkan break pada akhir case 1 dan 3 dan hapus kondisi default', 'Hapus kondisi default', 'Tambahkan break sebelum case 3', 'B', 2, 4),
...
(57, 'Seorang penjual bunga ingin membuat daftar bunga berdasarkan jenis bunga yang tersedia di tokonya. Dia memberikan kode angka untuk mengidentifikasi setiap jenis bunga, di mana 1 bunga  adalah \"mawar\", 2 bunga adalah \"tulip\", dan 3 bunga adalah \"anggrek\". Jika memasukan angka yang tidak valid maka menghasilkan output tidak valid. Penamaan variable dibebaskan. Apa contoh data yang diketahui dan apakah data-data yang diberikan sudah cukup untuk menentukan percabangan yang paling efektif (mengurangi sesuatu yang bertingkat-tingkat) yang dapat digunakan adalah switch untuk menentukan jenis bunga jika bahasa pemrograman yang digunakan adalah C++? ', '', ' Penentuan jenis bunga berdasarkan angka dan sudah cukup ', ' Penentuan jenis bunga berdasarkan angka dan belum cukup ', ' Penentuan jenis bungga berdasarkan angka dan kontradiktif ', 'Penentuan jenis bungga berdasarkan angka dan berlebihan', 'Tidak ada konteks yang jelas', 'A', 2, 1),
(58, 'Fira ingin membuat program dalam bahasa C++ yang akan meminta pengguna untuk memasukkan angka-angka bilangan bulat. Program akan melakukan input pertama di luar blok perulangan dan melakukan pengecekan kondisi di awal. Jika pengguna memasukkan angka negatif, maka program akan menghentikan perulangan. Namun, jika pengguna memasukkan angka positif atau nol, program akan terus meminta input angka hingga pengguna memasukkan angka negatif. Kira-kira apa perulangan yang cocok dan bagaimana  gambaran flowchartnya jika menggunakan bahasa C++ saja?', '', '28_a.PNG', '28_b.PNG', '28_c.PNG', '28_d.PNG', '28_e.PNG', 'B', 2, 2),
(59, 'Seorang karyawan ingin mendapatkan bonus tahunan dari perusahaannya. Jika karyawan tersebut mencapai minimal 90% dari target penjualan tahunannya, program akan mengeluarkan output \"Anda akan mendapatkan bonus tahunan\". Tidak ada aksi dan kondisi lainnya. Jika mencapai target dibawah 90 % maka program mengeluarkan output \"Anda tidak akan mendapat bonus tahunan\".Penamaan variable dibebaskan. Apa contoh data yang diketahui yang berhubungan dengan percabangan dan Apakah kondisi dan aksi pada soal sudah cukup untuk menentukan bahwa percabangan yang digunakan adalah percabangan tunggal jika menggunakan bahasa pemrograman C++ maupun Scratch? ', '', 'Jika mencapai minimal 90% dari target penjualan program dijalankan dan cukup', 'Jika mencapai  90% dari target penjualan program dijalankan dan kontradiktif', 'Jika mencapai minimal 90% dari target penjualan program dijalankan dan berlebihan', 'Jika mencapai 90% dari target penjualan program dijalankan dan tidak cukup', 'Tidak ada konteks yang jelas', 'B', 2, 1),
(60, 'Seorang siswa ingin membeli sebuah buku. Jika siswa tersebut memiliki uang minimal 50.000 rupiah, maka siswa dapat membeli buku yang diinginkan. Tidak ada aksi lainnya. Penamaan variable dibebaskan.  Apa percabangan yang paling sesuai dan bagaimana potongan flowchart jika nanti program yang dibuat dalam bahasa C++/Scratch?', '', '30_a.PNG', '30_b.PNG', '30_c.PNG', '30_d.PNG', '30_e.PNG', 'A', 2, 2);
...
(15, 'Seorang penjual es krim ingin mencatat penjualan es krimnya setiap hari selama seminggu. Dia memiliki data penjualan es krim dalam bentuk jumlah es krim yang terjual setiap hari. Buatlah program yang menggunakan perulangan untuk meminta penjual es krim memasukkan data penjualan selama 7 hari, dan kemudian menampilkan total penjualan selama seminggu. Total penjualan tanpa new line.Bahasa pemrograman yang digunakan adalah C++. Inputan dan total berupa integer, dan penamaan variable dibebaskan. Apa contoh data yang diketahui dan apakah data-data yang diberikan cukup untuk menentukan percabangan yang paling sesuai adalah for dan menuliskannya?', '', 'Program dibuat untuk membuat total dari inputan user selama 7 hari, Cukup', 'Program dibuat untuk membuat total dari inputan user selama 7 hari, Tidak Cukup', 'Program dibuat untuk membuat total dari inputan user selama 1 sampai 7 hari, Berlebihan', 'Program dibuat untuk membuat total dari inputan user selama 1 sampai 7 hari, Kontradiktif', 'Tidak ada konteks yang jelas', 'A', 'Jawaban yang tepat adalah A karena sudah cukup untuk menentukan bahwa perulangan yang tepat adalah for', 3, 1),
...
(18, 'Jika perhitungan hasil penjualan dilakukan untuk rentang waktu 5 hari dan menampilkan outputnya, apakah kode tersebut sudat tepat dan sesuai dengan perulangan yang paling efektif?', '3_4_soal.PNG', ' Sudah tepat dan tidak perlu diubah', ' Ubah menjadi perulangan for(int i = 1;i<=5;i++) dan berikan outputnya ', ' Ubah menjadi perulangan for', ' Inisialisasi hari = 1', ' Inisialisasi hari  = 1 dan berikan outputnya', 'B', 'Jawaban yang tepat adalah B karena perulangan yang tepat adalah For kemudian ubah batas atasnya menjadi 5 ', 3, 4),
(19, 'Seorang penjual online sedang melakukan pengiriman barang. Dia memiliki daftar pesanan yang perlu dikirimkan. Penjual tersebut ingin mengirim barang-barang tersebut hingga semua pesanan terkirim ke alamat tujuan. Namun, penjual memiliki kondisi bahwa dia akan terus mengirim barang hingga total berat pengiriman mencapai 100 kg. Proses pengecekan kondisi dilakukan di awal. Inputan pertama juga dilakukan diluar blok perulangan.Jika mencapai 100 di awal perulangan tidak dilakukan. Buatlah program yang menggunakan perulangan untuk memodelkan proses pengiriman barang oleh penjual hingga batas total berat pengiriman mencapai 100 kg. Bahasa pemrograman yang digunakan adalah C++ dan Scratch. Inputan berupa integer, dan penamaan variable dibebaskan. Output menampilkan total dari berat barang dalam string tanpa newline. Namun jika yang dimasukan berlebihan maka pada total ditampilkan berat berlebih.  Apa contoh data yang diketahui dan apakah data-data yang diberikan sudah cukup untuk menentukan perulangan while /repeat until yang digunakan dan menuliskannya?', '', ' Pengecekan dilakukan diawal, Cukup', ' Pengecekan dilakukan diawal, Tidak cukup', ' Pengecekan dilakukan diawal, Kontradiktif', ' Batas atas 100 kg, Berlebihan', ' Tidak ada konteks yang jelas', 'A', 'Jawaban yang tepat adalah A karena sudah cukup untuk menggambarkan perulangan while', 3, 1),
...
(37, 'Siti ingin membuat program yang mencetak angka 10 hingga 1 secara terbalik dengan variable angka. Kira-kira perulangan apa yang paling cocok digunakan dalam implementasi ini dalam bahasa C++ dan bagaimana flowchartnya? 	', '', '3_9_a.PNG', '3_9_b.PNG', '3_9_c.PNG', '3_9_d.PNG', '3_9_e.PNG', 'A', 'Jawabannya adalah A, karena paling sesuai perulangan for dan bentuk flowchartnya itu yang paling benar', 3, 2),
...
(40, 'Adi ingin membuat program yang mencetak tabel perkalian angka 5 dari 1 hingga 10 dengan variable i. Apa perulangan yang paling sesuai dan bagaimana gambaran flowchart yang paling sesuai dengan kasus ini jika bahasa pemrograman yang nanti digunakan adalah C++?', '', '3_12_a.PNG', '3_12_b.PNG', '3_12_c.PNG', '3_12_d.PNG', '3_12_e.PNG', 'A', 'Kunci jawaban yang sesuai adalah A, flowchart diagram yang paling sesuai', 3, 1),
(41, 'Buatlah program dalam C++ yang menggunakan perulangan for untuk mencetak deret bilangan ganjil dari 15 hingga 45 Jika diberikan flowchart sebagai berikut.', '3_13_soal.PNG', '3_13_a.png', '3_13_b.PNG', '3_13_c.PNG', '3_13_d.PNG', '3_13_e.PNG', 'A', 'Jawaban yang paling benar adalah A., Jawaban A adalah jawaban yang paling sesuai dengan flowchart yang diberikan', 3, 3),
...
(11, 1, 'Pertemuan1_LKPD_Percabangan.pdf'),
(15, 2, 'Pertemuan2_LKPD_Percabangan.pdf'),
(16, 3, 'Pertemuan3_LKPD_Perulangan.pdf'),
(17, 4, 'Pertemuan4_LKPD_Perulangan.pdf');
...
--
ALTER TABLE `tb_globalchat`
  MODIFY `id_globalchat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tb_groupchat`
--
ALTER TABLE `tb_groupchat`
  MODIFY `id_groupchat` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tb_hasilapersepsi`
--
ALTER TABLE `tb_hasilapersepsi`
  MODIFY `id_hasilapersepsi` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tb_hasilprepost`
--
ALTER TABLE `tb_hasilprepost`
  MODIFY `id_hasiltest` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tb_hasilquiz`
--
ALTER TABLE `tb_hasilquiz`
  MODIFY `id_hasilquiz` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tb_hasilrefleksi`
--
ALTER TABLE `tb_hasilrefleksi`
  MODIFY `id_refleksi` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tb_hasiltugas`
--
ALTER TABLE `tb_hasiltugas`
  MODIFY `id_hasiltugas` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tb_youtube`
  MODIFY `id_youtube` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
